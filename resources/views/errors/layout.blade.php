...
<body class="min-h-screen flex items-center justify-center p-6 text-white overflow-hidden">
    ...
    <div class="glass max-w-lg w-full p-12 rounded-3xl text-center relative z-10">
        <div class="mb-8">
            <h1 class="text-9xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 mb-2">@yield('code')</h1>
        ...
        <div class="flex flex-col gap-4">
            ...
            <button id="back-btn" onclick="window.history.back()" class="text-gray-500 hover:text-white transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:text-gray-500">
